...
/**
 * @ngdoc controller
 * @name  unchatbar-phone-book.controller:phoneBookAdmin
 * @require $scope
 * @require $stateParams
 * @require $modal
 * @require MessageText
...
angular.module('unchatbar-phone-book').controller('phoneBookAdmin', [
    ...
    function ($scope,$state, $stateParams,$modal, MessageText, PhoneBook, Stream) {
         ...
         * @ngdoc property
         * @name selectedUser
         * @propertyOf unchatbar-phone-book.controller:phoneBookAdmin
         ...
         * @ngdoc methode
         * @name removeClient
         * @methodOf unchatbar-phone-book.controller:phoneBookAdmin
